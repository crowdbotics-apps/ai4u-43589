...
const openaiapi_response_post_CreatechatcompletionsSlice = createSlice({
  ...
  extraReducers: builder => {
    builder
      .addCase(
        openaiapi_post_v1_chat_completions_create.pending,
        (state, action) => {
      ...
      .addCase(
        openaiapi_post_v1_chat_completions_create.fulfilled,
        (state, action) => {
      ...
      .addCase(
        openaiapi_post_v1_chat_completions_create.rejected,
        (state, action) => {
          if (state.api.loading === "pending") {
